...
Modulus.SQRL is an example file that the parser could interpret. It's an implementation of modulus using the language that is describe in the parser/interpreter
that was written.